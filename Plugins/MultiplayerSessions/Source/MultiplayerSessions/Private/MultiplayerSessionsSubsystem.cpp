...
void UMultiplayerSessionsSubsystem::FindSessions(int32 MaxSearchResults)
{
	...
	LastSessionSearch->bIsLanQuery = IOnlineSubsystem::Get()->GetSubsystemName() == "NULL"; //Returns true if the subsystem is NULL
...
/**
 * Callback for when a session search is complete
